    ...
    <div>
      <main>
        ...
        <div className="bg-[#f6f7f6] p-6 ">
          ...
          <h2 className="container mx-auto text-4xl font-semibold">Proven Partners Across the Cell Therapy Ecosystem</h2>
          <ImageCard>
          <div className="flex flex-col md:flex-row">
            <div className="p-5 md:p-10 md:w-1/2">
              <h3 className="text-2xl font-semibold pb-16">CDMO Services</h3>
              <Image
          ...
          <ImageCard>
            <div className="flex flex-col md:flex-row">
              <div className="p-5 md:p-10 md:w-1/2">
                <h3 className="text-2xl font-semibold pb-16">Products / Tools</h3>
                <Image
