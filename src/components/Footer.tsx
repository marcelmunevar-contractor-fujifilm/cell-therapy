      ...
      <div className="flex flex-col md:flex-row p-6 container mx-auto">
        ...
        <div className="md:px-10">
          <div className="flex flex-col md:flex-row ">
            <div className="md:after:content-[''] md:after:border-r after:border-[#AEADAD] text-xs xl:text-[18px] pb-4">
            ...
            <div className="text-xs xl:text-[18px] pb-8 md:pb-4">
              <a className="md:px-4" href="#">
                Cookie Settings
              </a>
            </div>
          </div>
          <div className="text-xs xl:text-sm mb-4">©FUJIFILM Holdings Corporation</div>
        </div>
